...
public class DateProviderTest {
    ...
    public void shouldIncrementDate() {
        assertEquals(EXPECTED_DATE_11_OCT_2014, format(getDirectlyIncrementedDate(dateProvider, date)));
    }

    @Test
    public void shouldDecrementDate() {
        assertEquals(EXPECTED_DATE_09_OCT_2014, format(getInverseIncrementedDate(dateProvider, date)));
    }
